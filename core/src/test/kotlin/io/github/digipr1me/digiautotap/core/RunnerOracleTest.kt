...
/**
 * The runner's readers against oracle/runner.json: every frame it names,
 * every reader of the family, and the answer has to be the one in the file.
 * The frames are `corpus/runner/`, the laboratory's own of 2026-09-19 in
 * both shapes -- the ADB frames of every dialog and the window frames of
 * the runs, where the readers were measured.
 *
...
class RunnerOracleTest {
    ...
    fun load() {
        ...
        val file = OracleFamilies.pathOf(OracleFamilies.RUNNER, repo)
