...
/**
 * The explore and farm readers against oracle/explore.json: every frame it
...
class ExploreFarmOracleTest {
    ...
    fun load() {
        ...
        val file = OracleFamilies.pathOf(OracleFamilies.EXPLORE, repo)
